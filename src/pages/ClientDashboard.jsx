...
//   const [bookings, setBookings] = useState([]); // paid bookings
//   const [pendingBookings, setPendingBookings] = useState([]); // pending/unpaid
//   const [editingProfile, setEditingProfile] = useState(false);
//   const [profileData, setProfileData] = useState({});
//   const [selectedFile, setSelectedFile] = useState(null);
//   const [previewImage, setPreviewImage] = useState(null);
//   const [activeTab, setActiveTab] = useState("bookings"); // "bookings" | "blogs"
...
//           API.get(`/booking/client/${clientId}`, { headers: authHeaders }), // paid (or all)
...
//     console.log("handleStartSession booking:", booking);

//     // Treat explicit chat sessions as chat
//     if (
//       booking.sessionType &&
...
//     // For everything else (video, or missing sessionType) → use booking ID
...
//   const otherName = (b) => b?.counselorId?.name;

//   // --- Split paid bookings into upcoming & completed ---
...
//       if (!start || !end) {
//         // If we can't compute time, just treat as upcoming
//         upcoming.push(b);
//         return;
//       }
...
//                         Role: <span className="font-semibold">client</span>
//                       </div>
//                     </div>
//                   </motion.div>
//                 )}
...
//                       const PRE_JOIN_MINUTES = 10; // how many minutes before start the link becomes active
...
//                   <h3 className="font-semibold text-[#1c1977] mt-6 mb-2">
//                     Completed Sessions
//                   </h3>
...
//                         size={48}
//                       />
//                       <p className="text-stone-500">No completed sessions</p>
//                     </Card>
//                   ) : (
...
// const COUNSELOR_DEFAULT_AVATAR =
...
//   const [pendingBookings, setPendingBookings] = useState([]); // unused now, but kept
//   const [editingProfile, setEditingProfile] = useState(false);
//   const [profileData, setProfileData] = useState({});
//   const [selectedFile, setSelectedFile] = useState(null);
//   const [previewImage, setPreviewImage] = useState(null);
...
//   const getCounselorAvatar = (b) =>
//     b?.counselorId?.profileImage || COUNSELOR_DEFAULT_AVATAR;
...
//                     className="inline-flex items-center gap-2 rounded-full bg-emerald-500 text-white text-[11px] font-semibold uppercase tracking-[0.16em] px-4 py-2 hover:bg-emerald-400 transition-colors"
//                   >
//                     <Video size={14} />
//                     Join
//                   </button>
...
//                               <div
//                                 className="w-11 h-11 rounded-xl bg-slate-100 overflow-hidden cursor-pointer"
//                                 onClick={() => {
...
//                               >
//                                 <img
//                                   src={getCounselorAvatar(b)}
//                                   alt={getCounselorName(b)}
...
// const getCounselorAvatar = (b) => {
//   const img = b?.counselorId?.profileImage;
//   if (!img) return COUNSELOR_DEFAULT_AVATAR;
